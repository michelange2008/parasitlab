    ...
    public function run()
    {
      DB::table('anaactes')->insert([
        ...
        [
          ...
          'description' => "Une analyse de mélange, vous permettra d'évaluer la sitation d'un groupe à moindre coût",
          'anatype_id' => 1,
          'estSerie' => false,
          'estAnalyse' => true,
          'estTarif' => true,
        ...
        [
          ...
          'nom' => "analyse de mélange (5 animaux maximum))",
          'description' => "Une analyse de mélange, vous permettra d'évaluer la sitation d'un groupe à moindre coût, tout en prenant en compte une évenutelle présence de petite douve en plus des strongles gastro-intestinaux ",
          'anatype_id' => 2,
          'estSerie' => false,
          'estAnalyse' => true,
          'estTarif' => true,
