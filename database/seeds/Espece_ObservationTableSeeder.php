...
class Espece_ObservationTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('espece_observation')->insert([
          ...
          [ "espece_id" => 2, "observation_id" => 5],
          [ "espece_id" => 2, "observation_id" => 6],
          [ "espece_id" => 2, "observation_id" => 7],
          [ "espece_id" => 2, "observation_id" => 9],
          ...
          [ "espece_id" => 6, "observation_id" => 5 ],
          [ "espece_id" => 6, "observation_id" => 6 ],
          [ "espece_id" => 6, "observation_id" => 31 ],
          [ "espece_id" => 6, "observation_id" => 11 ],
          [ "espece_id" => 6, "observation_id" => 12 ],
          [ "espece_id" => 6, "observation_id" => 17 ],
          [ "espece_id" => 6, "observation_id" => 20 ],
          [ "espece_id" => 6, "observation_id" => 22 ],
          [ "espece_id" => 6, "observation_id" => 23 ],
          [ "espece_id" => 7, "observation_id" => 1 ],
          [ "espece_id" => 7, "observation_id" => 4 ],
          [ "espece_id" => 7, "observation_id" => 5 ],
          [ "espece_id" => 7, "observation_id" => 11 ],
          [ "espece_id" => 7, "observation_id" => 12 ],
          [ "espece_id" => 7, "observation_id" => 17 ],
          [ "espece_id" => 7, "observation_id" => 21 ],
          [ "espece_id" => 7, "observation_id" => 22 ],
          [ "espece_id" => 7, "observation_id" => 23 ],
          [ "espece_id" => 7, "observation_id" => 30 ],
          [ "espece_id" => 8, "observation_id" => 1 ],
          [ "espece_id" => 8, "observation_id" => 4 ],
          [ "espece_id" => 8, "observation_id" => 5 ],
          [ "espece_id" => 8, "observation_id" => 11 ],
          [ "espece_id" => 8, "observation_id" => 12 ],
          [ "espece_id" => 8, "observation_id" => 17 ],
          [ "espece_id" => 8, "observation_id" => 21 ],
          [ "espece_id" => 8, "observation_id" => 22 ],
          [ "espece_id" => 8, "observation_id" => 23 ],
          [ "espece_id" => 8, "observation_id" => 30 ],
