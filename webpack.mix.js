...
mix.js('resources/js/app.js', 'public/js').js('resources/js/factures.js', 'public/js').js('resources/js/veterinaire_modif.js', 'public/js').js('resources/js/choisir.js', 'public/js')
