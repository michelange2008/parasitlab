...
return array (
  ...
  'tuto_choix' => "A vous de choisir, dans chaque catégorie, l'observation qui correspond le mieux à votre situation.",
  'tuto_clic' => "Et, par un clic, vous verrez s'afficher une ou plusieurs propositions d'analyses.",
