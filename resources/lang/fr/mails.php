...
return array (
  ...
  array (
    ...
    'how_reset_mdp' => 'Si vous souhaitez changer votre mot de passe et que vous l\'avez oublié, cliquez sur le bouton suivant&nbsp;',
    'info_veto' => 'Vous recevez cet email parce que vous nous avez fait une demande d\'analyse parasitologique pour un de vos éleveurs. Si ce n\'est pas le cas, il est possible qu\'un éleveur nous ait adressé une demande d\'analyse en vous nommant comme destinataire des résultats.',
    'info_eleveur' => 'Vous recevez cet email parce que vous nous avez fait une demande d\'analyse parasitologique . Si ce n\'est pas le cas, il est possible que votre vétérinaire nous ait adressé une demande d\'analyse en vous nommant comme destinataire des résultats.',
