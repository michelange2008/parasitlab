...
return array (
  ...
  array (
    ...
    'texte_3' => 'Mais cet examen est surtout utile pour surveiller les niveaux d\'infestation dans le cadre d\'une gestion raisonnée du parasitisme.',
  ),
  'nonvalide' =>
  array (
  ...
  array (
    ...
    'texte_3' => 'Certains parasites pondent peu ou de façon cyclique (grande et petite douve). Pour d\'autres parasites le comptage n\'a pas de sens (taenia) et ou ne peut être que semi-quantitatif (strongles respiratoires). Le niveau immunitaire des animaux hôtes influe aussi sur la capacité des parasites à pondre.',
  ),
);
