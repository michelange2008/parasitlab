...
return array (
  ...
  array (
    ...
    'qui' => 'Les animaux malades ou en mauvais état.<br>
  ...
  array (
    'titre' => 'Votre problème est (peut-être) d\'origine parasitaire',
    'soustitre' => 'Il s\'agit de confirmer le diagnostic.',
    'qui' => 'Les animaux qui ne produisent plus autant de lait qu\'avant ou ceux qui maigrissent.<br>

      Il est possible de faire une 2<sup>ème</sup> analyse avec les animaux en bon état',
    'quand' => 'Au moment de la constatation du problème.',
  ),
  'bilan' =>
  array (
  ...
  array (
    ...
    'qui' => 'Il faut faire un lot de 5 animaux&nbsp;:<br>
      En choisissant a priori des animaux susceptibles d\'être infestés=> maigres, anémiés, mauvais état général.',
    'quand' => 'C\'est une analyse à réaliser au pic de l\'infestation, c\'est-à-dire au mois de Juillet.<br>
