...
[
  ...
  [
    ...
    "qui" =>
      ...
      Il est conseillé de faire une 2<sup>ème</sup> analyse avec les animaux en bon état",

    "quand" =>

      "Au moment de la constatation du problème.",
  ...
  [
    ...
    "qui" =>
      ...
      "Il est indispensable de faire au moins trois lots de 5 animaux sur la base suivante&nbsp;:<br>
  ...
  [
    ...
    "qui" =>
      ...
      "Il faut faire au moins deux ou trois lots a priori de 5 animaux&nbsp;:<br>
      Un premier lot sera fait avec les jeunes et un deuxième lot sera fait avec les autres.",

    "quand" =>

      "Une première analyse peut être faite à la mise à l'herbe si aucun bilan n'a été fait l'année d'avant. Sinon, un premier prélèvement fin mai permet d'évaluer la montée de l'infestation.<br>
  ...
  [
    ...
    "qui" =>
      ...
      "Il faut faire un lot de 5 animaux&nbsp;:<br>
      En choisissant a priori des animaux susceptibles d'être infestés=> maigres, anémiés, mauvais état général.",

    "quand" =>

      "C'est une analyse à réaliser au pic de l'infestation, c'est-à-dire au mois de Juillet.<br>
      Mais il est possible de faire cette analyse à n'importe quel autre moment si on observe des signes de parasitisme, notamment liés à haemonchus (anémie).",
  ...
  [
    ...
    "qui" =>
      ...
      "Le nombre de lots dépend du nombre de produits que vous voulez évaluer.<br>
    ...
    "quand" =>
      ...
      "Une première analyse est faite le jour du traitement.<br>
