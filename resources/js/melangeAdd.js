...
$("#choix_troupeau").css("visibility", "hidden") // On rend invisible de bouton tant que l'éleveur et le troupeau ne sont pas choisis
...
$("#eleveur").on('change', function() {
  ...
  .done(function(datas) {
    ...
    // Sinon on fait une liste d'options avec une case vide au départ et la liste des troupeaux après
      ...
      var options = '<option value="Choisir un troupeau" disabled>' + troupeau.nom + '</option>';
