<div class="bg-bleu-tres-fonce p-3 align-items-middle color-bleu-tres-clair">
  ...
  <img class="d-inline d-lg-block img-claire" src="{!! asset('storage/img/icones').'/'.auth()->user()->usertype->icone->nom !!}" alt="">

  <h4 class="d-inline d-lg-block">Page personnelle</h4>
