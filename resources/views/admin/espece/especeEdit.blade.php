    ...
    <div class="container-fluid">
        ...
        <div class="row my-3 justify-content-center">
            ...
            <div class="col-md-10">
                ...
                <form action="{{ route('espece.update', $espece->id) }}" method="POST">
                        ...
                        @foreach ($icones as $icone)
                            <div class="d-flex flex-column border m-1 pb-1">
                                ...
                                @if ($icone->id == $espece->icone->id)
                                    <input type="radio" id="icone_{{ $icone->id }}" name="icone_id" checked
                                        value="{{ $icone->id }}">
                                @else
                                    <input type="radio" id="icone_{{ $icone->id }}" name="icone_id"
                                        value="{{ $icone->id }}">
                                @endif
                            </div>
                        @endforeach
