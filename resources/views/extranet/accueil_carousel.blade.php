  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption d-none d-md-block bandeau-bleu-tres-fonce text-left">
        ...
        {{-- <a class="btn btn-rouge" href="{{ route('analyses') }}">En savoir plus sur les analyses</a> --}}
      </div>
    </div>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block bandeau-bleu-tres-fonce">
        ...
        {{-- <a class="btn btn-rouge" href="{{ route('analyses') }}">En savoir plus sur les parasites</a> --}}
      </div>
    </div>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block bandeau-bleu-tres-fonce text-right">
        ...
        {{-- <a class="btn btn-rouge" href="{{ route('analyses') }}">En savoir plus sur les résistances</a> --}}
      </div>
    </div>
